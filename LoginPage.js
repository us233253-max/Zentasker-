...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-900 via-primary-800 to-primary-950 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-white">Zentasker</span>
          </Link>
        ...
        <div className="mt-6 bg-white/10 backdrop-blur rounded-xl p-4 text-center">
          ...
          <div className="text-white/60 text-xs space-y-1">
            <p>Admin: admin@zentasker.com / password</p>
            <p>Freelancer: freelancer@zentasker.com / password</p>
            <p>Client: client@zentasker.com / password</p>
          </div>
        </div>
      </div>
    </div>
